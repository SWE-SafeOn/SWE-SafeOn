...
\begin{table}[t]
    ...
    \begin{tabularx}{\linewidth}{|
        ...
        SAFEON-BE\newline /src/main/java/config &
        MlMqttProperties.java\newline
        RouterMqttProperties.java\newline
        SecurityConfig.java\newline
        SwaggerConfig.java\newline
        ...
        SAFEON-BE\newline /src/main/java/controller &
        ...
        SAFEON-BE\newline /src/main/java/dto &
        ApiResponseDto.java\newline
        SimpleMessageResponseDto.java\newline
        alert/AlertCreateRequestDto.java\newline
        alert/AlertResponseDto.java\newline
        dashboard/DailyAnomalyCountDto.java\newline
        dashboard/DailyAnomalyCountResponseDto.java\newline
        dashboard/DashboardDeviceDto.java\newline
        dashboard/DashboardDeviceListResponseDto.java\newline
        dashboard/DashboardOverviewDto.java\newline
        dashboard/RecentAlertListResponseDto.java\newline
        device/DeviceBlockRequestDto.java\newline
        device/DeviceDiscoveryRequestDto.java\newline
        device/DeviceResponseDto.java\newline
        device/DeviceTrafficPointDto.java\newline
        user/JwtResponseDto.java\newline
        user/LoginRequestDto.java\newline
        user/SignUpRequestDto.java\newline
        user/UserResponseDto.java\newline
        user/UserUpdateRequestDto.java &
        spring-boot-starter-web\newline
        spring-boot-starter-validation\newline
        lombok \\
        \hline

        SAFEON-BE\newline /src/main/java/mqtt &
        MlMqttClientService.java\newline
        MlRequestPublisher.java\newline
        MlResultMqttListener.java\newline
        MqttPacketListener.java\newline
        RouterMqttClientService.java\newline
        RouterMqttPacketListener.java &
        org.eclipse.paho.client.mqttv3\newline
        spring-boot-starter\newline
        spring-boot-starter-web\newline
        spring-boot-starter-websocket \\
        ...
        SAFEON-BE\newline /src/main/java/repository &
        AlertRepository.java\newline
        AnomalyScoreRepository.java\newline
...
\end{table}
    ...
    \begin{tabularx}{\linewidth}{|
        ...
        SAFEON-BE\newline /src/main/java/util &
        UuidParser.java &
        java.util\newline
        java.util.UUID \\
        \hline

        SAFEON-BE\newline /src/main/java/websocket &
        DeviceTrafficWebSocketHandler.java\newline
        JwtHandshakeInterceptor.java &
        spring-boot-starter-websocket\newline
        spring-boot-starter-security \\
        \hline

        SAFEON-BE\newline /src/main/resources &
        application.yml &
